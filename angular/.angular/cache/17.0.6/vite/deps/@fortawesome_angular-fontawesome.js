import { DomSanitizer } from "./chunk-R7IXJSQL.js"
import "./chunk-OE5OEHZQ.js"
import {
	Component,
	Directive,
	ElementRef,
...
function joinStyles(styles2) {
	return Object.keys(styles2 || {}).reduce(function (acc, styleName) {
		return (
			acc +
			"".concat(styleName, ": ").concat(styles2[styleName].trim(), ";")
		)
	}, "")
}
...
var faClassList = (props) => {
	const classes = {
		[`fa-${props.animation}`]:
			props.animation != null && !props.animation.startsWith("spin"),
		"fa-spin":
			props.animation === "spin" || props.animation === "spin-reverse",
		"fa-spin-pulse":
			props.animation === "spin-pulse" ||
			props.animation === "spin-pulse-reverse",
		"fa-spin-reverse":
		...
		if ("size" in changes) {
			if (changes.size.currentValue != null) {
				this.renderer.addClass(
					...
					`fa-${changes.size.currentValue}`,
				)
			}
			if (changes.size.previousValue != null) {
				this.renderer.removeClass(
					this.elementRef.nativeElement,
					`fa-${changes.size.previousValue}`,
				)
			}
		}
	}
...
_FaStackComponent.ɵfac = function FaStackComponent_Factory(t) {
	return new (t || _FaStackComponent)(
...
var _FaIconComponent = class _FaIconComponent {
	...
	ngOnChanges(changes) {
		...
		if (changes) {
			const iconToBeRendered =
				this.icon != null ? this.icon : this.config.fallbackIcon
	...
	buildParams() {
		...
		const parsedTransform =
			typeof this.transform === "string"
				? parse$1.transform(this.transform)
				: this.transform
		return {
			title: this.title,
...
var _FaDuotoneIconComponent = class _FaDuotoneIconComponent extends FaIconComponent {
	...
	buildParams() {
		...
		if (this.primaryOpacity != null) {
			params.styles["--fa-primary-opacity"] =
				this.primaryOpacity.toString()
		}
		if (this.secondaryOpacity != null) {
			params.styles["--fa-secondary-opacity"] =
				this.secondaryOpacity.toString()
		}
...
_FaDuotoneIconComponent.ɵfac = (() => {
	...
	return function FaDuotoneIconComponent_Factory(t) {
		return (
			ɵFaDuotoneIconComponent_BaseFactory ||
			(ɵFaDuotoneIconComponent_BaseFactory = ɵɵgetInheritedFactory(
				_FaDuotoneIconComponent,
			))
		)(t || _FaDuotoneIconComponent)
	}
})()
...
var faWarnIfParentNotExist = (parent, parentName, childName) => {
	if (!parent) {
		throw new Error(
			`${childName} should be used as child of ${parentName} only.`,
		)
	}
}
...
_FaLayersComponent.ɵfac = function FaLayersComponent_Factory(t) {
	return new (t || _FaLayersComponent)(
		ɵɵdirectiveInject(Renderer2),
		ɵɵdirectiveInject(ElementRef),
		ɵɵdirectiveInject(FaConfig),
	)
...
_FaLayersCounterComponent.ɵfac = function FaLayersCounterComponent_Factory(t) {
	return new (t || _FaLayersCounterComponent)(
		ɵɵdirectiveInject(FaLayersComponent, 8),
		ɵɵdirectiveInject(DomSanitizer),
	)
}
...
_FaLayersTextComponent.ɵfac = function FaLayersTextComponent_Factory(t) {
	return new (t || _FaLayersTextComponent)(
		ɵɵdirectiveInject(FaLayersComponent, 8),
		ɵɵdirectiveInject(DomSanitizer),
	)
}
